        ...
        console.error(e)
            ...
            for (let name in global.plugins) {
                ...
                if ((usedPrefix = (match[0] || '')[0])) {
                    ...
                    if (xp > 200) m.reply('chillando -_-') // Hehehe
                    else m.exp += xp
                    if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
                        this.reply(m.chat, `Su límite ha disminuido, compre a través de *${usedPrefix}buy*`, m)
...
detectado @${participant.split`@`[0]} mensaje eliminado
